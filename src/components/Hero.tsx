          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-lg text-secondary-foreground/80 max-w-md">
                Discover cutting-edge technology and premium gadgets. From smartphones to laptops, 
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-border/30 text-secondary-foreground hover:bg-secondary-foreground/5 px-8 py-3 text-lg"
              >
                View Catalog
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-secondary-foreground">Free Shipping</p>
                  <p className="text-sm text-secondary-foreground/60">On orders $99+</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-secondary-foreground">Warranty</p>
                  <p className="text-sm text-secondary-foreground/60">2-year coverage</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-secondary-foreground">Fast Delivery</p>
                  <p className="text-sm text-secondary-foreground/60">2-day shipping</p>
                </div>
              </div>
            </div>
          </div>
